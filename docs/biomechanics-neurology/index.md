---
title: Biomechanics & Neurology
description: Anatomy, joint chain, neuromuscular control system, motor learning, and pressure inoculation — the science of tennis performance.
language: en
---
...
-   :material-dna:{ .lg } **Layer 1 — The Foundation**
    ...
    **Geometry, the kinetic chain, footwork phases.** The angles at contact, the spring principle (cheetah vs Alcaraz), the thoracic cage as a 3D rotating pump.
    ...
    [Read DD1 →](#chapter-1-foundation)

-   :material-triangle-outline:{ .lg } **Layer 2 — The Structure**
...
1. **Split-step** — small hop as opponent strikes the ball; primes the nervous system
2. **Push** — first explosive step toward the ball direction
3. **Recovery** — 2 adjustment steps back toward the center mark
...
1. **Search** — eyes scan for ball trajectory
2. **Detect** — ball is identified in flight
3. **Track** — eyes follow ball through approach
4. **Focus** — eyes lock on contact zone (~50 ms before contact)
5. **Quiet Eye** — gaze stabilizes on contact point for 200+ ms (the marker of expert performance)
...
1. **Cognitive** — "thinking through" every movement (slow, error-prone)
2. **Associative** — practice refines the movement (fewer errors, more consistency)
3. **Autonomous** — movement runs without conscious thought (fast, automatic, free up cognitive resources for tactics)
...
But myelination requires:
- **Repetition** — many trials of the same movement
- **Feedback** — knowing whether the movement was correct
- **Sleep** — myelin growth consolidates during deep sleep
...
1. **Constraint-based training** — practice under constraints (smaller court, faster ball machine, scoreboard pressure) that mimic match stress
2. **Simulation training** — full match simulation in practice (down 4-2 in third set, crowd noise, time pressure)
3. **Visualization** — mental rehearsal of high-pressure points to pre-activate the same neural pathways as physical practice
...
-   :material-book-open-variant:{ .lg } **Stroke Analysis**
...
-   :material-magnify:{ .lg } **Tennis Wiki Reference**
    ...
    [Browse Pressure & Neurology →](../tennis-wiki-reference/pressure-neurology/index.md)

-   :material-layers-triple:{ .lg } **Reference Library**
