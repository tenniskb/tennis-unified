...
Looking for a clear and concise explanation of how to develop maximum
power on the serve? In the second article in this new series, John Craig
explores belief and reality for this widely misunderstood and
controversial topic.

The wrist he finds is at most a conduit that passes power to the ball.
But the source that generates that power lies somewhere else---in the
rotation of the shoulder.

Watch John demonstrate the path of this rotation as well as trace it in
the motion of the master of the effortless high velocity serve, Roger
Federer.

![Video demonstration](media_service-shoulder-power/media/image1.png)
...
![Logo, company name](media_service-shoulder-power/media/image3.jpeg)
