# Ultimate Drill Games - The Serve Box - Six Targets Game
...
Every player knows they need to drill. But how do you optimize focus and
benefit in the part of training that can be most tedious and boring? My
answer is drill games. In this new series I am presenting a series of
drill games covering every aspect of the game, starting with the serve.

This month we start with the 6 Targets Game. We divide each service box
into thirds. That's 6 boxes. The game is to see how many serves---first
serves, then seconds---it takes to hit each box. This game quickly
reveals the true amount of control over serve location the player has.
And it gives them a way to measure improving each location.
...
generated](media_ultimate-drill-games-the-serve-box-six-targets-game/media/image1.jpeg)
...
| +---------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+ |  |  |  |
| --- | --- | --- | --- |
|  | **Tennisplayer Forum** | ![forum](media_ultimate-drill-games-the-serve-box-six-targets-game/media/image2.gif) |  |
| +---------------------------------------------------------------------------------------------------------------------------------------+ |  |  |  |
