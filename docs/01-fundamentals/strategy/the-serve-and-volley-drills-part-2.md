# Serve and Volley: Drills Part 2
...
One of the biggest challenges in mastering serve and volley is getting a
high number of practice repetitions. You need repetitions of the range
of first volleys that are required become an accomplished attacking
player. The table drill solves this problem in a fabulous way.
...
placement of the first volley over and over. You can move the table
anywhere around the service box for target practice and can adjust the
...
Serve and volley players need to understand that dealing successful with
these variations requires patience. Many players I see are pretty good
...
Here is how it works. The server takes a shadow serve and approaches the
net. The coach then feeds a high ball high for a swinging volley and
plays out the point.

If the attacking player wins the point, he immediately receives a
regular volley. If he wins this point, he immediately receive an
overhead. If he wins the overhead exchange, he scores one point.

Meanwhile the returner scores a point winning any one of the three
...
these drills create. Building high numbers of successful repetitions
